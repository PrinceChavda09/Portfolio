...
export default function Header() {
  ...
  return (
    <nav id='navbar' className="w-full shadow-lg bg-black text-white p-4 relative">
      ...
      {isMenuOpen && (
        <div className='lg:hidden absolute top-full left-0 w-full bg-black flex flex-col items-center gap-6 py-6 border-t border-gray-800 z-50'>
          <a href="#navbar" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2A8FEA]">Home</a>
          <a href="#AboutSection" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2A8FEA]">About</a>
          <a href="#" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2A8FEA]">Skills</a>
          <a href="#" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2A8FEA]">Projects</a>
          <a href="#" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2A8FEA]">Contact</a>
        </div>
      )}
    </nav>
  );
